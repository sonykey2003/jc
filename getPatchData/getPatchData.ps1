# The idea for getting the patch info from the machine to a centralised location

# Github vars
$GHUsername = 'sonykey2003'
$GHToken = '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' # https://github.com/settings/tokens needs token to write/create repo
